...
def create_files(site, bg_color, element_color, protection, url):
...
if __name__ == '__main__':
    ...
    url = "test/test/test"  # Vous pouvez ajuster cela selon vos besoins

    create_files(site, bg_color, element_color, protection, url)
